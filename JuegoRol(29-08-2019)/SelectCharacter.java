...
public class SelectCharacter extends World
{
    ...
    public SelectCharacter(String raceWin)
    {
     super(1200, 800, 1); 
     if(raceWin == "Protoss")  
     {
         addObject(p3, 587, 384);
        } 
     else if(raceWin == "Terran")
     {
        addObject(p1, 587, 384);
        }
     else if (raceWin == "Zerg")
     {
         addObject(p2, 587, 384);
        }
    }    
     ...
     if(Greenfoot.mouseClicked(p1))
      {
          ...
          */
          ...
          Greenfoot. setWorld(new Koprulu("Terran",azar(),0,false));
      ...
      else  if(Greenfoot.mouseClicked(p2))
      {
          ...
          aux=1;
          Greenfoot. setWorld(new Koprulu("Zerg", azar(),0,false));
       ...
       else if(Greenfoot.mouseClicked(p3))
      {
          //igual...
          aux=2;
          Greenfoot. setWorld(new Koprulu("Protoss", azar(),0,false));
        } 
